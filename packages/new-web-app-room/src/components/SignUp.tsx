...
export default function SignUp({ onDiscordSignIn, onGoogleSignIn }: SignUpProps) {
  return (
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 w-full max-w-md border border-white/20">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white py-3 px-6 rounded-lg font-semibold transition-all duration-200 flex items-center justify-center space-x-3"
          >
          ...
          <button
            ...
            className="w-full bg-white hover:bg-gray-50 text-gray-900 py-3 px-6 rounded-lg font-semibold transition-all duration-200 flex items-center justify-center space-x-3 border border-gray-300"
          >
